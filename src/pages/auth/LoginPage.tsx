  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-2xl font-black text-white tracking-tight">Rural Health Connect</h2>
        <p className="text-xs text-gov-green-400 font-semibold mt-1">Government of Maharashtra Public Healthcare Access Platform</p>
        <div className="inline-block mt-3 bg-slate-800 text-slate-300 text-[11px] px-3 py-1 rounded-full border border-slate-700 font-medium">
          <Sparkles className="w-3 h-3 inline text-gov-green-400 mr-1" /> SIH 2026 Problem ID: 26133
        </div>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-2xl rounded-2xl sm:px-10 border border-slate-200">
          <h3 className="text-sm font-bold text-slate-900 mb-4 text-center">Select Role to Enter Platform Demo</h3>
            ...
            {availableDemoUsers.map((u) => (
              ...
              >
                <div>
                  ...
                  <div className="text-[11px] text-gov-green-700 font-semibold">{u.role.replace('_', ' ')}</div>
                </div>
