...
export const WorkerTriageHistory: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="p-6 sm:p-7 rounded-3xl bg-gradient-to-r from-teal-950 via-emerald-950 to-slate-900 text-white shadow-xl border-2 border-emerald-600/50 relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
