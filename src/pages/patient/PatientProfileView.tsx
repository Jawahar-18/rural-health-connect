  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-gradient-to-br from-emerald-900 via-teal-950 to-slate-950 text-white rounded-3xl p-6 sm:p-8 border-2 border-emerald-500/50 shadow-2xl relative overflow-hidden space-y-6">
          <div className="absolute top-0 right-0 w-60 h-60 bg-emerald-400/10 rounded-full blur-3xl pointer-events-none"></div>
